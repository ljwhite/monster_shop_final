...
RSpec.describe 'Cart Discount ' do
  describe 'As a Visitor' do
    before :each do
      ...
      @discount1 = Discount.create!(name: "Spring Sale", item_quantity: 3, discount_percentage: 5, merchant: @megan)
    end

    it "discounts are applied automatically in my cart if I qualify for that merchant's discount" do
